...
export default function BranchDropdownSelector({
  ...
  return (
    <div className="space-y-4 border border-border-dark/60 rounded-2xl p-6 bg-surface-dark/20">
        ...
        {branches.map((branch) => {
          ...
          return (
            <button
              ...
              className={`p-4 rounded-xl border text-left transition-all duration-300 flex flex-col justify-between group cursor-pointer w-full focus:outline-none ${
                isSelected
            ...
            >
              <div className="w-full">
                ...
                <p className="text-[11px] text-text-gray/70 leading-relaxed font-sans font-light mb-3">
                  {branch.description}
                </p>
              </div>
